...
export class DashUserManagementPage extends HelperBase {
  ...
  get searchUsernameInput() {
    return this.page
      .locator(".oxd-input-group", {
        has: this.page.locator('label:has-text("anna12345")'),
      })
      .locator("input");
  }
  get titleText() {
    return this.page.locator("div.oxd-table-filter-header-title h5");
  }
  get userTableRows() {
  ...
  async deleteUserByUsername(username: string) {
    ...
    const confirmDeleteButton = await this.page.locator(
