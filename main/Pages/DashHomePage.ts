...
export class DashHomePage extends HelperBase {
    ...
    get dashHomePageTitle() { return this.page.locator('[class*="oxd-topbar-header-breadcrumb-module"]') }
    ...
    async navigateToMenu(menuName: string) {
        ...
        switch (menuName) {
            case NavigationMenu.Admin:
                return import('./DashUserManagementPage.ts').then(p => new p.DashUserManagementPage(this.page));
